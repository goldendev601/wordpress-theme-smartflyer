...
<div class="wp-container">
    ...
    <section>
        <div class="destination-banner background" style="background-image: url(<?php echo get_stylesheet_directory_uri() ?>/images/destinations/asia-hero.jpg);">
                ...
                <div class="explore-main-wrap">
                    <div class="explore-wrap">
                        <div class="inner">
                            <div class="left">
                                <div class="image ">
                                    <img src="<?php echo get_stylesheet_directory_uri() ?>/images/destinations/asia-maldives.jpg">
                                </div>
                                <div class="content">
                                    <ul>
                                    </ul>
                    ...
                    <div class="explore-wrap" style="z-index: 2; position: relative;">
                        <div class="inner">
                            <div class="left">
                                <div class="image ">
                                    <img src="<?php echo get_stylesheet_directory_uri() ?>/images/destinations/asia-singapore.jpg">
                                </div>
                                <div class="content">
                                    <ul>
                                    </ul>
					...
					<div class="explore-wrap">
                        <div class="inner">
                            <div class="left" style="display: flex; justify-content:flex-end; width: 50%;">
                                <div class="image">
                                    <img src="<?php echo get_stylesheet_directory_uri() ?>/images/destinations/asia-3.jpg">
                                </div>
                                <div class="content">
                                    <ul>
                                    </ul>
						...
						<select class="form-select region">
							...
							<?php
                                ...
                                if ($regions) {
                                    ...
                                    ?>
                                    <option value='<?php echo $region->slug; ?>' <?php echo $region->slug == 'asia' ? 'selected' : '' ?>><?php echo $region->name; ?></option>
                                    <?php
                                    endforeach;
                                }
                            ?>
