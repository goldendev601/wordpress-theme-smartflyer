<?php
/*
Template Name: Americas Template
*/
...
<div class="wp-container">
    ...
    <section>
        <div class="destination-banner background" style="background-image: url(<?php echo get_stylesheet_directory_uri() ?>/images/destinations/americas-hero.jpg);">
                ...
                <div class="explore-main-wrap">
                    <div class="explore-wrap">
                        <div class="inner">
                            <div class="left">
                                <div class="image ">
                                    <img src="<?php echo get_stylesheet_directory_uri() ?>/images/destinations/americas-new-england.jpg">
                                </div>
<!--                                 <div class="content">
                                    <ul>
                                        <li>Newport</li>
                            ...
                            <div class="right">
                                ...
                                <p>With so much ground to cover, choosing a destination to visit stateside presents endless variety. Our SmartFlyer travel advisors are based across the country, so we've compiled their expert local advice on everywhere from Nantucket to New Orleans and so many more spots in between.</p>
                    ...
                    <div class="explore-wrap" style="z-index: 2; position: relative;">
                        <div class="inner">
                            <div class="left">
                                <div class="image ">
                                    <img src="<?php echo get_stylesheet_directory_uri() ?>/images/destinations/americas-austin.jpg">
                                </div>
                            </div>
                            <div class="right">
                            </div>
					...
					<div class="explore-wrap">
                        <div class="inner">
                            <div class="left" style="display: flex; justify-content:flex-end; width: 50%;">
                                <div class="image">
                                    <img src="<?php echo get_stylesheet_directory_uri() ?>/images/destinations/americas-3.jpg">
                                </div>
	...
	<section class="destination-partners-section">
		<div class="container">
						...
						<select class="form-select region">
							...
							<?php
                                ...
                                if ($regions) {
                                    ...
                                    ?>
                                    <option value='<?php echo $region->slug; ?>' <?php echo $region->slug == 'americas' ? 'selected' : '' ?>><?php echo $region->name; ?></option>
                                    <?php
                                    endforeach;
                                }
                            ?>
			...
			<div class="button-1 text-center">
				<a href="javascript:void(0);" id="load-more-reviews">EXPLORE MORE AMERICA</a>
			</div>
		</div>
	</section>
    <!-- Partners -->
