...
<div class="wp-container">
    ...
    <section>
        <div class="destination-banner background" style="background-image: url(<?php echo get_stylesheet_directory_uri() ?>/images/africa.jpg);">
                ...
                <div class="explore-main-wrap">
                    <div class="explore-wrap">
                        <div class="inner">
                            <div class="left">
                                <div class="image ">
                                    <img src="<?php echo get_stylesheet_directory_uri() ?>/images/destinations/africa-morroco.jpg">
                                </div>
                                <div class="content">
                                    <ul>
                                    </ul>
                            ...
                            <div class="right">
                                ...
                                <p>From northern Africa's most requested destinations like Morocco and Egypt to the most untouched depths of southern Africa, a trip to this vast continent could take thousands of forms. Rest assured that pairing with a SmartFlyer travel advisor to plan your trip makes for simple navigation through Africa's nuances cultures and climates.</p>
                            </div>
                        </div>
                    </div>
                    <div class="explore-wrap" style="z-index: 2; position: relative;">
                        <div class="inner">
                            <div class="left">
                                <div class="image ">
                                    <img src="<?php echo get_stylesheet_directory_uri() ?>/images/destinations/africa-namib-desert.jpg">
                                </div>
                                <div class="content">
                                    <ul>
                                    </ul>
					...
					<div class="explore-wrap">
                        <div class="inner">
                            <div class="left" style="display: flex; justify-content:flex-end; width: 50%;">
                                <div class="image">
                                    <img src="<?php echo get_stylesheet_directory_uri() ?>/images/destinations/africa-3.jpg">
                                </div>
                                <div class="content">
                                    <ul>
                                    </ul>
	...
	<section class="destination-partners-section">
		<div class="container">
						...
						<select class="form-select region">
							...
							<?php
                                ...
                                if ($regions) {
                                    ...
                                    ?>
                                    <option value='<?php echo $region->slug; ?>' <?php echo $region->slug == 'africa' ? 'selected' : '' ?>><?php echo $region->name; ?></option>
                                    <?php
                                    endforeach;
                                }
                            ?>
			...
			<div class="button-1 text-center">
				<a href="javascript:void(0);" id="load-more-reviews">EXPLORE MORE AFRICA</a>
			</div>
		</div>
	</section>
    <!-- Reviews -->
